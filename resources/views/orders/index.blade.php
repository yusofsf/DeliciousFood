...
<div class="flex items-center justify-between">
                        ...
                        <h4 class="text-gray-400">سفارش توسط:</h4>
                            <div class="flex items-center justify-between">
                                <p class="font-medium text-gray-600">نام کاربری:</p>
                                <p>${order.user.user_name}</p>
                            </div>
                            <div class="flex items-center justify-between">
                                <p class="font-medium text-gray-600">ایمیل:</p>
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    if (data.errors) {
                        ...
                        alert(data.message || 'نتوانستیم سفارش را لغو کنیم. دوباره تلاش کنید.');
                    }
                }
            } catch (error) {
                console.error('Error canceling order:', error);
                alert('نتوانستیم سفارش را لغو کنیم دوباره تلاش کنید.');
            }
        }
